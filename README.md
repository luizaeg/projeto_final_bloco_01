# Projeto Livraria Cultura (e-commerce) - Java
...
O **Projeto Livraria Cultura (e-commerce)** é um sistema de gestão desenvolvido para simular e administrar operações comuns em um comércio virtual. Oferece funcionalidades como **cadastro**, **consulta**, **atualização** e **remoção** de produtos.
...
Abaixo, você confere o Diagrama de Classes do Projeto Livraria Cultura (e-commerce):
...
1. Clone o repositório do Projeto [Livraria Cultura](https://github.com/luizaeg/projeto_final_bloco_01) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/luizaeg/projeto_final_bloco_01.git
```
...
1. Na guia **Package Explorer**, localize o Projeto Livraria Cultura
